<?php  
    ...
    $query="SELECT id_pinjaman,nama_anggota,tanggal_pinjaman,jumlah_pinjaman,status_pinjaman FROM anggota JOIN pinjaman USING (id_anggota) WHERE status_pinjaman='belum lunas' ORDER BY tanggal_pinjaman DESC,id_pinjaman DESC";
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar topbar scrl" style="top:0;width: 100%;">
          <!-- <div class="container"> -->
            <div class="row">
              <div class="col-12">
              <h4 class="text-left">Pinjaman Lunas</h4>
              </div>
            </div>
          <!-- </div> -->
        </nav>
      ...
      <!-- <h4 class="text-center mb-4">Pinjaman Sudah Lunas</h4> -->

      <!-- form tambah pemasukan -->
     <!--  <?php if(isset($_SESSION['login'])){ ?>
        <?php if($_SESSION['login']=='admin'){ ?>
        <button id="trigerpinjaman" class="btn btn-primary mb-4">
            ...
            <tbody>
              ...
              <?php $no=1; foreach($getdatapinjaman as $pinjaman): ?>
                <tr>
                  ...
                  <td>Rp <?=str_replace(',','.',number_format($pinjaman['jumlah_pinjaman'])); ?></td>
                  <td><a href="detailpinjaman.php?idpinjaman=<?=$pinjaman['id_pinjaman']; ?>" class="badge"><i class="far fa-fw fa-arrow-alt-circle-right" style="font-size: 25px;color: blue;"></i></a></td>
                </tr>
              <?php $no++;  endforeach; ?>
            ...
            <tbody>
              ...
              <?php $nomer=1; foreach($getdatapinjamanlunas as $pinjamanl): ?>
                <tr>
                  ...
                  <td><a href="detailpinjaman.php?idpinjaman=<?=$pinjamanl['id_pinjaman']; ?>" class="badge"><i class="far fa-fw fa-arrow-alt-circle-right text-primary" style="font-size: 25px;color: blue;"></i></a></td>
                </tr>
