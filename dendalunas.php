...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar topbar scrl" style="top:0;width: 100%;">
          <!-- <div class="container"> -->
            <div class="row">
              <div class="col-12">
              <h4 class="text-left">Denda Lunas</h4>
              </div>
            </div>
          <!-- </div> -->
        </nav>
      ...
      <!-- <h4 class="text-center mb-4">Denda Sudah Lunas</h4> -->

      <!-- form tambah pemasukan -->
      <!-- <?php if(isset($_SESSION['login'])){ ?>
        <?php if($_SESSION['login']=='admin'){ ?>
        <button id="trigerdenda" class="btn btn-primary mb-4">
        ...
        <tbody>
          ...
          <?php $no=1; foreach($getdatadenda as $denda): ?>
              <tr>
                ...
                <td><a href="detaildenda.php?iddenda=<?=$denda['id_denda']; ?>" class="badge"><i class="far fa-fw fa-arrow-alt-circle-right" style="font-size: 25px;color: blue;"></i></a></td>
              </tr>
          <?php $no++; endforeach; ?>
        ...
        <tbody>
          ...
          <?php $nomer=1; foreach($getdatadendalunas as $dendal): ?>
              <tr>
                ...
                <td><a href="detaildenda.php?iddenda=<?=$dendal['id_denda']; ?>" class="badge"><i class="far fa-fw fa-arrow-alt-circle-right text-primary" style="font-size: 25px;color: blue;"></i></a></td>
              </tr>
